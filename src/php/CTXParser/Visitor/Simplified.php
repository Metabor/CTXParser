...
class Simplified extends Visitor
{
    ...
    protected function visitTransaction($transaction)
    {
        ...
        $new->date          = gmmktime(
            $transaction->valutaDate[0]->time[0]->hour - $transaction->valutaDate[0]->inUtc,
            $transaction->valutaDate[0]->time[0]->min,
            $transaction->valutaDate[0]->time[0]->sec,
            $transaction->valutaDate[0]->date[0]->month,
